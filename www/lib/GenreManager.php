...
class GenreManager
{
    ...
    public static function getGenresByCategory(): array
    {
        ...
        $categories = [
          ...
          'Приключения' => ['adv','adv_', 'adventure','adv_history','adv_indian','adv_maritime','adv_geo','adv_animal','adventure','child_adv','adv_modern','tale_chivalry','adv_story','adv_all','adv_western','child_adv_animal'],
          ...
          'Техника' => ['sci_tech','sci_build','sci_radio','sci_metal','sci_transport','auto_business','equ_history','military_weapon'],
          ...
          'Юмор' => ['humor_anecdote','humor_prose','humor','humor_satire','humor_all', 'humor_fantasy'],
