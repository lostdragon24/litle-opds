...
class Translator
{
    ...
    private function loadLanguage($lang)
    {
        ...
        if (isset(self::$translationsCache[$lang])) {
            ...
            my_log("Translator: Using cached translations for {$lang}");
            return;
        }
        ...
        if (file_exists($langFile)) {
            ...
            my_log("Translator: Loaded " . count($this->translations) . " translations from $langFile");
        } else {
...
public function translate($key, $params = [])
{
    ...
    {
        my_log("Translator::setLanguage() called with: " . $lang);
        ...
        if ($this->languageDetector->setLanguage($lang)) {
            ...
            my_log("Translator::setLanguage() - Language changed to: " . $lang);
            return true;
        }
        my_log("Translator::setLanguage() - Failed to change language");
        return false;
    }
